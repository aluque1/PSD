...
int main(int argc, char *argv[])
{
	...
	if (rank == MASTER)
	{
		...
		masterFunction(window, renderer, size, worldWidth, worldHeight, totalIterations, autoMode, distModeStatic, grainSize);
		...
		if (outputFile != NULL)
		{
			saveImage(renderer, outputFile, worldWidth * CELL_SIZE, worldHeight * CELL_SIZE); // TODO da error de malloc
		}
