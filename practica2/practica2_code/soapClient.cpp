...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.8.130 2023-11-08 18:38:52 GMT")


SOAP_FMAC5 int SOAP_FMAC6 soap_call_blackJackns__register(struct soap *soap, const char *soap_endpoint, const char *soap_action, const struct tMessage& playerName, int *result)
{	if (soap_send_blackJackns__register(soap, soap_endpoint, soap_action, playerName) || soap_recv_blackJackns__register(soap, result))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC5 int SOAP_FMAC6 soap_send_blackJackns__register(struct soap *soap, const char *soap_endpoint, const char *soap_action, const struct tMessage& playerName)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv_blackJackns__register(struct soap *soap, int *result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_blackJackns__registerResponse = soap_get_blackJackns__registerResponse(soap, NULL, "blackJackns:registerResponse", NULL);
